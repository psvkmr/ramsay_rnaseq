---
title: "S303 - Control v Reactive LN excluding sample NAT 7"
...
md <- md[!md$sample_id %in% c('NAT 4', 'NAT 7'), ]

# Also drop from CM
zcm <- zcm[, !colnames(zcm) %in% 'NAT.7_S7']
ncm <- ncm[, !colnames(ncm) %in% 'NAT.7_S7']
...
#write_csv(deseq.dfs$reactive_ln, 'C:/Users/Prasanth/google_drive/guys/ramsey/s303_control_v_reactiveln_excluding_NAT7S7.csv')
