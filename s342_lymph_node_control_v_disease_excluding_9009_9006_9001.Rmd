---
title: "S342 TCL1 Lymph Node Disease v Ctrl excluding samples 9009LNS46, 9006LNS40, 9001LNS32"
...
```{r modify_md}
md <- md[!md$sample %in% c('9009-LN_S46', '9006-LN_S40', '9001-LN_S32'), ]

# Also drop from CM
zcm <- zcm[, !colnames(zcm) %in% c('9009-LN_S46', '9006-LN_S40', '9001-LN_S32')]
ncm <- ncm[, !colnames(ncm) %in% c('9009-LN_S46', '9006-LN_S40', '9001-LN_S32')]
...
smpls <- rownames(md[md$MouseModel == 'TCL1' & md$Tissue == 'LN', ])
nat.cm <- zcm[, smpls]
nat.ncm <- ncm[, smpls]
nat.md <- md[smpls, ]
...
bi.plt.smpls <- 
  biplot(pcas, showLoadings = F, colby = 'Disease', 
                                  ...
                                  axisLabSize = 8, borderWidth = 0.5, xlim = c(-120, 120), ylim = c(-50, 50))
bi.plt.smpls
```
...
write_csv(deseq.dfs, 'C:/Users/Prasanth/google_drive/guys/ramsey/s342_lymph_node_control_v_disease_excluding_9009-LN_S46_9006-LN_S40_9001-LN_S32.csv')
...
```{r mirna, message=FALSE, warning=FALSE, echo=FALSE, include=FALSE}
# nothing interesting so exclude from report
...
```{r corum, message=FALSE, echo=FALSE, include=FALSE, warning=FALSE}
# nothing interesting so exclude from report
