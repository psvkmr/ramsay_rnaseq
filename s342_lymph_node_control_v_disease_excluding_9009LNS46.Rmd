---
title: "S342 TCL1 Lymph Node Disease v Ctrl excluding sample 9009LNS46"
...
```{r modify_md}
md <- md[!md$sample %in% c('9009-LN_S46'), ]

# Also drop from CM
zcm <- zcm[, !colnames(zcm) %in% '9009.LN_S46']
ncm <- ncm[, !colnames(ncm) %in% '9009.LN_S46']
...
#write_csv(deseq.dfs, 'C:/Users/Prasanth/google_drive/guys/ramsey/s342_lymph_node_control_v_disease_excluding_9009-LN_S46.csv')
